...
const ToDo = ({ task, index, taskList, setTaskList }) => {
    ...
    return (
        <>
            <div className="flex flex-col bg-white justify-start my-4  my-4 py-4 px-6 w-3/4 max-w-lg"  ref={drag}>
                ...
                <div className="w-full flex justify-center" >
                    <button className="bg-red-500 text-white mb-1 mt-6 text-sm font-semibold py-2 px-3 rounded-lg uppercase " onClick={handleDel} >Delete</button>
                </div>
